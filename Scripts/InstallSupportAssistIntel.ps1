...
Invoke-WebRequest 'https://downloadmirror.intel.com/28425/a08/Intel-Driver-and-Support-Assistant-Installer.exe' -OutFile 'C:\Temp\Core\Drivers\Intel\Intel-Driver-and-Support-Assistant-Installer.exe'
